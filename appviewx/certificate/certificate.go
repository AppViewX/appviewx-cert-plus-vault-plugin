...
type CaConnectorInfo struct {
	...
	ValidityUnitValue     string            `json:"validityUnitValue,omitempty"`
...
func GeneratePayloadForCertificateCreate(csrContent *string, currentCert *CurrentCert, ca *ca.CA, certSettings *certSettings.CertSettings) (payload Payload) {
	payload = Payload{}

	payload.UploadCsrDetails = UploadCsrDetails{}
	payload.UploadCsrDetails.CsrContent = *csrContent
...
func getCAConnectorInfo(currentCert *CurrentCert, ca *ca.CA, certSettings *certSettings.CertSettings) (output CaConnectorInfo) {
	...
	output.ValidityUnitValue = certSettings.ValidityUnitValue
	output.ValidityUnit = certSettings.ValidityUnit
